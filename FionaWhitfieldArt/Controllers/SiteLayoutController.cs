...
namespace FionaWhitfieldArt.Controllers
{
    public class SiteLayoutController : SurfaceController
    {
        ...
        {
            return PartialView(PARTIAL_VIEW_FOLDER + "_Intro.cshtml", CurrentPage);
        }

        public ActionResult RenderTitleControls()
        {
            return PartialView(PARTIAL_VIEW_FOLDER + "_TitleControls.cshtml", CurrentPage);
        }
        ...
        private List<NavigationListItem> GetNavigationModelFromDatabase()
        {
            ...
            // https://codeshare.co.uk/blog/simple-umbraco-rss-xml-feed-example/
        ...
        private static T GetObjectFromCache<T>(string cacheItemName, int cacheTimeInMinutes, Func<T> objectSettingFunction)
        {
            if (true)
            {
                ...
                var cachedObjectTmp = objectSettingFunction();
                return cachedObjectTmp;
            }
